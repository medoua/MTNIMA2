...
return new class extends Migration
{
    ...
    {
        Schema::create('org_ches',function (Blueprint $table) {
        ...
        Schema::create('Even_ches',function (Blueprint $table) {
        ...
        Schema::create('ptfs_ches',function (Blueprint $table) {
        ...
        Schema::create('miss_ches',function (Blueprint $table) {
