...
<table class="table"> <tr> <td>
    <!-- Recherche -->
<form method="POST" action="{{ route('Evenement_rech') }}" class="d-flex">
    @csrf
                    <input id="rech_even" type="text" class="form-control col-md-5 me-2" name="rech_even" placeholder="Recherche" value="" width=15%>
...
<a href="{{ route('Evenement.create') }}"  class="btn btn-outline-success ">
...
<tr>
        ...
        <td scope="row"> 
            <a href="{{ route('Evenement_AF' , $item->id) }}" class="btn btn-outline-info center"> 
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
            ...
            {{ __('Afiche') }} </a>
                    ...
                    @if(auth()->check() && (auth()->user()->isAdmin() || auth()->user()->isSuperAdmin()))
        <td scope="row"> 
            <a href="{{ route('Evenement_M' , $item->id) }}" class="btn btn-outline-primary center"> 
