...
<table class="table"> <tr> <td>
    <!-- Recherche -->
<form method="POST" action="{{ route('qui_org_rech') }}" class="d-flex" role="search">
                    @csrf
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/>
     ...
     <!-- Ajouter -->
<a href="{{ url('/qui_org/create') }}"  class="btn btn-outline-success ">
...
<tr>
        ...
        <th scope="row"> {{$item->nom_qui_org}}</th>
        <th scope="row"> {{$item->created_at}}</th>
       
        <th scope="row"> 
            <a href="{{ route('qui_org_AF' , $item->id) }}" class="btn btn-outline-info center">
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
        ...
        <th scope="row"> 
            <a href="{{ url('qui_org_M' , $item->id) }}" class="btn btn-outline-primary center">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
        ...
        <th scope="row"> 
            <form  action="{{route('qui_org_D' , $item->id) }}" method="post" class="d-inline">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-outline-danger" 
                    onclick="return confirm('Sumprimier {{$item->nom_qui_org}} ?')"
                    >
