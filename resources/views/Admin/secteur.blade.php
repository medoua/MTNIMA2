...
<table class="table"> <tr> <td>
    <!-- Recherche -->
<form method="POST" action="{{ route('Secteur_rech') }}" class="d-flex" role="search">
                    @csrf
                    <input id="rech_secteur" type="text" class="form-control col-md-5 me-2" name="rech_secteur"  placeholder="Recherche" width=15%>
 ...
 <td>
     <!-- Ajouter -->
<a href="{{ url('/Secteur_i/create') }}"  class="btn btn-outline-success ">
...
<tr>
        ...
        <th scope="row"> 
            <a href="{{ route('Secteur_i.show' , $item->id) }}" class="btn btn-outline-info bi bi-eye-fill center">
  ...
  <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/>
        ...
        <th scope="row"> 
            <a href="{{ url('Secteur_modif' , $item->id) }}" class="btn btn-outline-primary center">
